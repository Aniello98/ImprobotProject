...
/* 
  ...
  r_low_final_angle=LOOK_UP_RIGHT_LOW_R;
  r_high_final_angle=LOOK_UP_RIGHT_HIGH_R;
  l_low_final_angle=LOOK_UP_RIGHT_LOW_L;
  l_high_final_angle=LOOK_UP_RIGHT_HIGH_L;

  r_low_final_angle=LOOK_UP_RIGHT_LOW_R;
  r_high_final_angle=LOOK_UP_RIGHT_HIGH_R;
  l_low_final_angle=LOOK_DOWN_LEFT_LOW_L;
  l_high_final_angle=LOOK_DOWN_LEFT_HIGH_L;

  r_low_final_angle=LOOK_DOWN_RIGHT_LOW_R;
  r_high_final_angle=LOOK_DOWN_RIGHT_HIGH_R;
  l_low_final_angle=LOOK_UP_LEFT_LOW_L;
  l_high_final_angle=LOOK_UP_LEFT_HIGH_L;*/
 /*
  ...
  r_low_final_angle=DIVIDE_LOW_R;
  r_high_final_angle=DIVIDE_HIGH_R;
  l_low_final_angle=DIVIDE_LOW_L;
  l_high_final_angle=DIVIDE_HIGH_L;
   *//*
  r_low_final_angle=LOOK_UP_LOW_R;
  r_high_final_angle=LOOK_UP_HIGH_R;
  l_low_final_angle=LOOK_DOWN_LOW_L;
  ...
  */
  ...
  fr_final_angle=NORMAL_FR;
  fl_final_angle=NORMAL_FL;
  b_final_angle=NORMAL_B;
  b_d_final_angle=NORMAL_B_D;
 /*
  fr_final_angle=FRONT_FR;
  fl_final_angle=FRONT_FL;
  b_final_angle=FRONT_B;
  b_d_final_angle=FRONT_B_D;
   */ /*
  fr_final_angle=RIGHT_FR;
  fl_final_angle=RIGHT_FL;
  b_final_angle=RIGHT_B;
  b_d_final_angle=RIGHT_B_D;
 
  fr_final_angle=LEFT_FR;
  fl_final_angle=LEFT_FL;
  b_final_angle=LEFT_B;
  b_d_final_angle=LEFT_B_D;

  fr_final_angle=BACK_FR;
  fl_final_angle=BACK_FL;
  b_final_angle=BACK_B;
  b_d_final_angle=BACK_B_D;
*/
  body_speed=5;
...
void body_callback (const std_msgs::Int8MultiArray&msg){
   ...
   switch(movement_type){
    case NORMAL:
          ...
          break;
    case BOW:
          fr_final_angle=FRONT_FR;//FR_MIDDLE;
          fl_final_angle=FRONT_FL;//FL_MIDDLE;
          b_final_angle=FRONT_B;
          b_d_final_angle=FRONT_B_D;
          break;
    case BOW_RIGHT:
...
void eyes_callback(const std_msgs::Int8MultiArray&msg){
  ...
  eyes_speed=msg.data[1];
    ...
    case EYES_DIVIDE:
          ...
          l_high_final_angle=DIVIDE_HIGH_L;
          break;
    case EYES_L_UP_R_DOWN:
          r_low_final_angle=LOOK_DOWN_LOW_R;
          r_high_final_angle=LOOK_DOWN_HIGH_R;
          l_low_final_angle=LOOK_UP_LOW_L;
          l_high_final_angle=LOOK_UP_HIGH_L;
          break;
    case EYES_R_UP_L_DOWN:
          r_low_final_angle=LOOK_UP_LOW_R;
          r_high_final_angle=LOOK_UP_HIGH_R;
          l_low_final_angle=LOOK_DOWN_LOW_L;
          l_high_final_angle=LOOK_DOWN_HIGH_L;
          break;
     case EYES_DANCE_STYLE1:
          r_low_final_angle=LOOK_UP_RIGHT_LOW_R;
          r_high_final_angle=LOOK_UP_RIGHT_HIGH_R;
          l_low_final_angle=LOOK_DOWN_LEFT_LOW_L;
          l_high_final_angle=LOOK_DOWN_LEFT_HIGH_L;
          break;
     case EYES_DANCE_STYLE2:
          r_low_final_angle=LOOK_DOWN_RIGHT_LOW_R;
          r_high_final_angle=LOOK_DOWN_RIGHT_HIGH_R;
          l_low_final_angle=LOOK_UP_LEFT_LOW_L;
          l_high_final_angle=LOOK_UP_LEFT_HIGH_L;
